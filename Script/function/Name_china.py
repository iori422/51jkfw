...
# def last_name(size=1, chars=string.ascii_letters + string.digits):
#     return ''.join(random.choice(chars) for _ in range(size))
#
# # print(last_name(1, surname))


   listname =['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地', '为',
   ...
   list =random.choice(listname)
   first = random.choice(listname)
   China_name = sur+list+first
   return China_name
c= CHinaname()
